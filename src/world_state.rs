...
mod tests {
    ...
    fn character_count_returns_correct_value() {
        ...
        let data = SaveData {
            characters: vec![
                CharacterSave {
                    name: "A".to_string(), hitpoints: 100, max_hitpoints: 100,
                    position_x: 0, position_y: 0, position_z: 0,
                    map: 0, stats: (50, 50, 50), gold: 0,
                    skills: std::collections::HashMap::new(),
                },
                CharacterSave {
                    name: "B".to_string(), hitpoints: 100, max_hitpoints: 100,
                    position_x: 0, position_y: 0, position_z: 0,
                    map: 0, stats: (50, 50, 50), gold: 0,
                    skills: std::collections::HashMap::new(),
                },
                CharacterSave {
                    name: "C".to_string(), hitpoints: 100, max_hitpoints: 100,
                    position_x: 0, position_y: 0, position_z: 0,
                    map: 0, stats: (50, 50, 50), gold: 0,
                    skills: std::collections::HashMap::new(),
                },
